...
var high = parseInt(document.getElementsByClassName("fhighTemp").value);
var low = parseInt(document.getElementsByClassName("flowTemp").value);
...
document.getElementsByClassName("windChill").innerHTML = parseFloat(d.toFixed(0));
